...
user/_mkfifo:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
  ...
  10:	6584                	ld	s1,8(a1)
    ...
    if (mkfifo(path) < 0) {
  12:	8526                	mv	a0,s1
  14:	354000ef          	jal	368 <mkfifo>
  18:	02054063          	bltz	a0,38 <main+0x38>
  ...
  28:	87c58593          	addi	a1,a1,-1924 # 8a0 <malloc+0x104>
  2c:	4509                	li	a0,2
  2e:	690000ef          	jal	6be <fprintf>
        exit(1);
  32:	4505                	li	a0,1
  34:	284000ef          	jal	2b8 <exit>
        fprintf(2, "mkfifo: failed to create named pipe at %s\n", path);
  38:	8626                	mv	a2,s1
  3a:	00001597          	auipc	a1,0x1
  3e:	87e58593          	addi	a1,a1,-1922 # 8b8 <malloc+0x11c>
  42:	4509                	li	a0,2
  44:	67a000ef          	jal	6be <fprintf>
        exit(1);
  48:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b0:	54450513          	addi	a0,a0,1348 # 8f0 <digits>
 3b4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 646:	2aeb8b93          	addi	s7,s7,686 # 8f0 <digits>
 ...
 694:	25890913          	addi	s2,s2,600 # 8e8 <malloc+0x14c>
        for(; *s; s++)
